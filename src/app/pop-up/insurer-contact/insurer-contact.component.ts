...
@Component({
  selector: 'app-insurer-contact',
  templateUrl: './insurer-contact.component.html',
  styleUrls: ['./insurer-contact.component.css']
})
export class InsurerContactComponent implements OnInit {
