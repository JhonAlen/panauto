...
@Component({
  selector: 'app-service-request-tracing',
  templateUrl: './service-request-tracing.component.html',
  styleUrls: ['./service-request-tracing.component.css']
})
export class ServiceRequestTracingComponent implements OnInit {
  ...
  onSubmit(form){
    ...
    let fseguimiento = new Date(`${form.fdia} ${form.fhora}`);
    ...
    this.tracing.fseguimientosolicitudservicio = fseguimiento;
