...
@Component({
  selector: 'app-notification-tracing',
  templateUrl: './notification-tracing.component.html',
  styleUrls: ['./notification-tracing.component.css']
})
export class NotificationTracingComponent implements OnInit {
  ...
  onSubmit(form){
    ...
    this.tracing.fseguimientonotificacion = fseguimiento;
