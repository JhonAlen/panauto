...
@Component({
  selector: 'app-notification-replacement',
  templateUrl: './notification-replacement.component.html',
  styleUrls: ['./notification-replacement.component.css']
})
export class NotificationReplacementComponent implements OnInit {
