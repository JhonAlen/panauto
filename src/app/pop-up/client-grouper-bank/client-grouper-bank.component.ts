...
@Component({
  selector: 'app-client-grouper-bank',
  templateUrl: './client-grouper-bank.component.html',
  styleUrls: ['./client-grouper-bank.component.css']
})
export class ClientGrouperBankComponent implements OnInit {
