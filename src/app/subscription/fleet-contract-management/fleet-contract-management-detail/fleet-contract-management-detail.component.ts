...
*/
  ...
  async createPDF2(){
    ...
    // pdf.download(`Contrato - ${this.xnombrecliente}`, function() { alert('Se ha descargado el Contrato Exitosamente'); location.reload()});  
    //pdfMake.createPdf(pdfDefinition).download(`Contrato - ${this.xnombrecliente} - N° - ${this.xpoliza}`, function() { alert('El PDF se está Generando');});
  }
      ...
      content: [
        ...
        },
        {
          ...
          table: {
            widths: ['*'],
            body: [
              [{text: 'El TOMADOR y el BENEFICIARIO declaran que han recibido en este acto las Condiciones Generales y Particulares del Contrato, el CUADRO', alignment: 'justify', border: [true, false, true, false]}]
            ]
          }
        },
        {
          ...
          table: {
            widths: ['*'],
            body: [
              [{text: 'RECIBO del Contrato, así como los Anexos emitidos hasta este momento debidamente firmados por las partes.', alignment: 'justify', border: [true, false, true, false]}]
            ]
          }
        },
        { 
        ...
        },
        {
          ...
          table: {
            widths: ['*'],
            body: [
              [{text: 'RECIBO del Contrato', alignment: 'justify', border: [true, false, true, true]}]
            ]
          }
        },
        {
