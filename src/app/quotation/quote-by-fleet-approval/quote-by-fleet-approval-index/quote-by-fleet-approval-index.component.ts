...
@Component({
  selector: 'app-quote-by-fleet-approval-index',
  templateUrl: './quote-by-fleet-approval-index.component.html',
  styleUrls: ['./quote-by-fleet-approval-index.component.css']
})
export class QuoteByFleetApprovalIndexComponent implements OnInit {
  ...
  rowClicked(event: any){
    this.router.navigate([`quotation/quote-by-fleet-approval-detail/${event.data.ccotizadorflota}`]);
  }
